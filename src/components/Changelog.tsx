...
const logs: LogEntry[] = [
  {
    ...
    type: 'feature',
    changes: [
      'Подключена база данных Firebase Firestore с автосохранением каждые 5 минут',
      'Внедрена система учета издержек и расчета себестоимости',
      'Проведена полная адаптация интерфейса для мобильных устройств',
      'Приложение переименовано в "Кафе Мастер"',
